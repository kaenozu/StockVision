...
class Watchlist(Base):
    ...
    # Alert prices
    alert_price_high: Mapped[Optional[Decimal]] = mapped_column(
        DECIMAL(10, 2), nullable=True
    )
    alert_price_low: Mapped[Optional[Decimal]] = mapped_column(
        DECIMAL(10, 2), nullable=True
    )
    ...
    def validate_alert_price_relationship(self) -> None:
        ...
        if (
            self.alert_price_high is not None
            and self.alert_price_low is not None
            and self.alert_price_high <= self.alert_price_low
        ):
    ...
    def should_alert_high(self, current_price: Decimal) -> bool:
        ...
        return (
            self.is_active
            and self.alert_price_high is not None
            and current_price >= self.alert_price_high
        )
    ...
    def should_alert_low(self, current_price: Decimal) -> bool:
        ...
        return (
            self.is_active
            and self.alert_price_low is not None
            and current_price <= self.alert_price_low
        )
