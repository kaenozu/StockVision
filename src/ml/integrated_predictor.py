...
class IntegratedPredictor:
    ...
    def __init__(self, lstm_weight: float = 0.5, ensemble_weight: float = 0.5):
        ...
        logger.info(
            f"Integrated predictor initialized - LSTM: {self.lstm_weight:.1%}, Ensemble: {self.ensemble_weight:.1%}"
        )
    ...
    def predict(
        self, stock_code: str, use_adaptive_weights: bool = True
        ...
        try:
            ...
            logger.info(
                f"Integrated prediction completed for {stock_code}: "
    ...
    def get_model_info(self, stock_code: str) -> Dict:
        """統合モデル情報を取得"""
        lstm_info = (
            lstm_predictor.get_model_info(stock_code)
        ...
        return {
            "integrated": {
                ...
                "weights": {"lstm": self.lstm_weight, "ensemble": self.ensemble_weight},
            },
            "lstm": lstm_info,
