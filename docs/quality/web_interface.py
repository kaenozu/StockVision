...
from .quality_manager import QualityManager, QualityReport, QualityRules
...
async def health_check():
    ...
    return {
        "status": "healthy",
        "version": "1.0.0",
        "reports_count": sum(len(reports) for reports in quality_manager.reports_history.values())
    }
            ...
            try:
                ...
                if content.strip():
                    ...
                    result = {
                        ...
                        "data": json.loads(quality_manager.export_report(report, "json"))
                    }
