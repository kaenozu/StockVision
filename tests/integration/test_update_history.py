...
class TestUpdateHistory:
    ...
    async def test_toyota_data_update_workflow(
        ...
        mock_ticker_instance.history.return_value.to_dict.return_value = {
            'Close': {i: data['close'] for i, data in enumerate(mock_toyota_history_data)},
            'Volume': {i: data['volume'] for i, data in enumerate(mock_toyota_history_data)}
        }
    ...
    async def test_json_format_output(
        self, 
        setup_test_db, 
        mock_toyota_history_data
    ):
    ...
    async def test_table_format_history(
        self, 
        setup_test_db, 
        mock_toyota_history_data
    ):
