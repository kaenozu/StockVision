...
3. Query via CLI  
4. Add to watchlist via CLI5. Verify data persistence
"""
...
class TestCompleteWorkflow:
    ...
    def test_step2_add_stock_data_via_api(self):
        ...
        with patch("src.stock_api.yahoo_client.YahooClient") as mock_yahoo:
            ...
            mock_instance.get_stock_data.return_value = MockStockData(
                self.mock_yahoo_data["7203"]
            )
    ...
    def test_complete_workflow_integration(self):
        ...
        watchlist_data = {"stock_code": "7203", "notes": "Complete workflow test"}
        response = self.client.post("/watchlist", json=watchlist_data)
        assert response.status_code == 201
