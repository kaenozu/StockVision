...
@pytest.mark.skip(
    reason="Legacy test - CORS configuration has been refactored to use new settings system"
)
...
def test_compute_allowed_cors_origins_prod_only(monkeypatch):
    # Arrange
    os.environ["PROD_CORS_ORIGINS"] = (
        "https://prod.example.com, https://www.stockvision.jp"
    )
